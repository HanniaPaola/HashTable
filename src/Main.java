...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("1. Insertar un nuevo negocio");
            System.out.println("2. Ver todos los negocios");
            System.out.println("3. Buscar un negocio por su respectivo ID");
            ...
            switch (choice) {
                case 1:
                    System.out.print("Ingrese ID del Negocio: ");
                    String id = scanner.nextLine();
                    System.out.print("Ingrese Nombre de Negocio: ");
                    ...
                    long endTime = System.nanoTime();
                    System.out.println("Tiempo de funcion hash 1: " + (endTime - startTime) + " ns");

                    startTime = System.nanoTime();
                    hashTable2.put(id, business, false);
                    endTime = System.nanoTime();
                    System.out.println("Tiempo de funcion hash 2: " + (endTime - startTime) + " ns");
                    break;
                case 2:
